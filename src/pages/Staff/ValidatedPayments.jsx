    ...
    useEffect(() => {
        ...
        const load = async () => {
            ...
            try {
                ...
                const validatedRows = rows.filter((payment) => VALIDATED_SOURCES.has(payment?.source));
                if (active) setPayments(validatedRows);
            } catch (requestError) {
                if (active) {
                    setPayments([]);
    ...
    return (
        <div className="space-y-6 pb-4">
            <PageHeading
                ...
                description="Resultados de los últimos 30 días: únicamente pagos validados por el Portal de Autogestión y el Asistente Virtual Rapidito."
                action={(
